...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_subtract = QPushButton(self.gridLayoutWidget)
        self.button_subtract.setObjectName(u"button_subtract")
        ...
        self.button_subtract.setBaseSize(QSize(50, 50))
        self.button_subtract.setFont(font)

        self.buttonLayout.addWidget(self.button_subtract, 2, 3, 1, 1)
        ...
        self.buttonLayout.addWidget(self.button_equals, 10, 3, 1, 1)

        self.button_comma = QPushButton(self.gridLayoutWidget)
        ...
        self.button_comma.setBaseSize(QSize(50, 50))
        self.button_comma.setFont(font)

        self.buttonLayout.addWidget(self.button_comma, 10, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_subtract.setText(QCoreApplication.translate("MainWindow", u"-", None))
        ...
        self.label_display.setText(QCoreApplication.translate("MainWindow", u"0", None))
